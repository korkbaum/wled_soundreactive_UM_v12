...
//#define USERMOD_ID_POWERLED      13          //Usermod "usermod_powerled.h" don't use together with usermod Powerled or change touch pin 
...
#define OMAX 5500     //was 2048, had to be increased to handle a bunch of additional entries in cfg.json
