...
None</option><option value="1">Brighter</option><option value="2">Accurate
 ...
 type="submit">Save</button><hr><h2>Effects Selection</h2><button type="button" 
onclick="checkall_fx()">Activate all Effects</button><button type="button" 
onclick="uncheckall_fx()">De-Activate All</button><div id="fxlist">Loading...
</div><hr><button type="button" onclick="B()">Back</button><button 
type="submit">Save</button><hr><h2>Palettes Selection</h2><button type="button" 
onclick="checkall_pal()">Activate all Palettes</button><button type="button" 
onclick="uncheckall_pal()">De-Activate All</button><div id="selectPalette">
Loading...</div><button type="button" onclick="B()">Back</button><button 
